...
try
{
    ...
    builder.Services.RegisterAuthPermissions<Permissions>(options =>
    {
        ...
        options.EncryptionKey = "asfafffggdgerxbd";
    ...
    .IndividualAccountsAuthentication<Persona>()
    .RegisterAuthenticationProviderReader<PersonaSyncIndividualAccountUsers>()
    .AddSuperUserToIndividualAccounts<Persona>()
    .RegisterTenantChangeService<TenantChangeService>()
    .SetupAspNetCoreAndDatabase(options =>
    {
        //Migrate individual account database
        options.RegisterServiceToRunInJob<StartupServiceMigrateAnyDbContext<AppDbContext>>();
    ...
    builder.Services.AddTransient<IAddNewUserManager, IndividualUserAddUserManager<Persona>>();
