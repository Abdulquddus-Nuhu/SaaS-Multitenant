...
namespace Core.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<ApiResponse<LoginResponse>> LoginAsync(LoginRequest request)
        {
            ...
            var tokenResult = _tokenService.GetToken(new PersonaResponse() {Datakey = user.DataKey, UserName = user.UserName, Email = user.Email, FirstName = user.FirstName, Id = user.Id, LastName = user.LastName, PhoneNumber = user.PhoneNumber, Roles = userRoles, });
